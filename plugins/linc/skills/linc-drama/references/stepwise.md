...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards" \
...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards/$SB_ID/extract-assets" \
  -H "Authorization: Bearer $LINC_API_KEY"
```
...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards/$SB_ID/assets" \
  -H "Authorization: Bearer $LINC_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards/$SB_ID/assets/$ASSET_ID/generate-image" \
  -H "Authorization: Bearer $LINC_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "$LINC_HOST/api/shots/storyboards/$SB_ID/projects" \
  -H "Authorization: Bearer $LINC_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "$LINC_HOST/api/shots/storyboards/$SB_ID/projects/$SP_ID/generate" \
  -H "Authorization: Bearer $LINC_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards/$SB_ID/shot-projects/$SP_ID/episodes/$EP_ID/video-items" \
  -H "Authorization: Bearer $LINC_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards/$SB_ID/shot-projects/$SP_ID/episodes/$EP_ID/video-items/$ITEM_ID/quick-generate" \
  -H "Authorization: Bearer $LINC_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards/$SB_ID/shot-projects/$SP_ID/episodes/$EP_ID/video-items/auto-generate-segments" \
  -H "Authorization: Bearer $LINC_API_KEY" \
  -H "Content-Type: application/json" \
...
```bash
curl -s -X POST "$LINC_HOST/api/storyboards/$SB_ID/shot-projects/$SP_ID/episodes/$EP_ID/video-items/export" \
  -H "Authorization: Bearer $LINC_API_KEY"
```
